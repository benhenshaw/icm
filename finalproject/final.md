...
![Fig. 1 — Photograph of the final piece.](images/inside.png)
...
The poem is shown below. Hovering your mouse over the <span class="sensor">italic</span> words will show you which sensor they are effected by.

<div id="poem">

Our bodies are sensors\
Detecting the <span class="sensor" title="Light Sensor">darkness/light</span> that surrounds us\
Informing the thoughts that become us\

Our words, they can chain us\
Tell us the weight of the lives of the beings around us\

I am <span class="sensor" title="Soil Moisture Sensor">drowning/sinking/floating</span> in this soil that surrounds us\
<span class="sensor" title="UV Sensor">Starved/Nourished/Burnt</span> by these boundaries that divide us\

I <span class="sensor" title="Temperature Sensor">shiver/ache/melt</span> waiting for your gentle touch to join us.
...
![Fig. 3 — Ideas for the initial bone prototype.](images/bonesketch.png)
...
I began to explore labour in a different form, namely dance. I believed it could be interesting to have participants perform for their “wokeness", satirising the gamification and popular trends of language around social justice. However, when creating music for this project I realised that there was something special about the simple connection between body and beat. The act of dancing was both liberating and energising. Dance is a form of exercise that combines self expression and creativity, and has a strong ties to the LGBTQIA+ community (Severson, 2017). This brought me to the final iteration of the project, known now as *If We Can Dance*, which attempts to offer a more uplifting, liberating experience.

At this point I focused on the idea of exploring dance as a method of self empowerment, and by extension a form of protest. Inspired by recent LGBTQIA+ dance protests in response to rising extremism and violence towards the LGBTQIA+ and BME community, I wanted to promote dance as a method of self love, self acceptance, and as a method for accessing serotonin production. I  combined this idea with Dance Dance Revolution's dance mechanism — using a dance mat to guide the participants movement. This was incorporated to help remove the anxiety of dancing, and to provide a distraction from the rest of the exhibition. I felt it was necessary to write my own music tailored to the experience, with lyrics that communicate the ideas explored through my creative research. To hear this music please play the video shown in figure 7.
...
<figcaption>Fig.&nbsp;7 — Full audio track from If We Can Dance.</figcaption>
</figure>
...
With the overall aesthetics of the piece, I wanted to embody a futuristic, solar-punk, transparent-technology aesthetic. The reason for this was to further embody that feeling of optimism and trust. To do this I took hundreds of pictures of different plants and scanned wires to make collages. This took quite a lot of time and significant learning, as I do not have a strong background in graphic design software. I used Affinity Designer to remove the background of the plants using vector curves, and create these collages. See figure 12 below for a video of how this was done.
...
![Fig. 13 — Title screen.](images/title.png)
...
<figure>
<iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/o9T08XbRHAI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
<figcaption>Fig.&nbsp;14 — Screen recording of the dance experience.</figcaption>
</figure>
...
With the code working and the UI finalised, my material arrived and I was ready to put together the dance squares. At first I thought it would be best to sew little pockets that the sensors could slide into. However, when the material arrived I discovered that it was a lot thicker and stiffer than I originally thought. I did some prototyping to see how they would look by sticking the material down with tape, see figure 18 below.

![Fig. 18 — Constructing the dance pads.](images/padtest.jpg)
...
I believe that I really pushed myself in terms of all of my skill sets with this piece. I did significant amount of background research and spent a lot of time iterating through ideas to get to a place where I felt the piece was strong. In past exhibitions I struggled with being satisfied with the final piece as I often spent more time constructing it than I did researching and iterating. These iterations gave so much clarity on the purpose of the piece and the aesthetics. I had a deep understanding of the goals of the piece, these being the following: have the audience question the labels of human and animal, empower the participant to use their bodies to feel pleasure and provoke empathy and joy. This in-depth understanding of the piece allowed me to evaluate all of my choices based on these goals. This meant the piece was able to come together in a relatively short amount of time. I gave myself just under two months for the construction of the piece and this ended up being just enough time. I was very careful with planning out my days, and was entirely focused to ensure that the execution of the piece was to the best of my ability.
...
I didn't face any severe technical issues during the four days of the exhibition. The only problem I encountered was that the Linux computer that I was running my dancing experience on refused to boot up on the Saturday. This meant that I had to run the piece on my laptop on Saturday and Sunday, but this wasn't really an issue.

If I was to further iterate on the piece, I would try and explore how to make the plant poetry more readable, as I think that without some more explanation, some participants may have found it difficult to read the complexities of the ideas I was presenting. Perhaps I could have provided an exhibition booklet with the piece, however I do think that some of the ambiguities of the piece led to more audience exploration.

This was the hardest I have ever worked on a piece, so I am very satisfied with the outcome and I am proud of what I was able to achieve for my final university piece. I was able to learn so much and ignite so much curiosity within myself. In the future I would like to continue to explore these ideas further, and to create more music. This piece has given me the confidence to be able to do that.

## Contributions

In terms of my contribution to the exhibition organisation I was part of the marketing team and coordinated the following:

- Painting and cleaning the exhibition space.
- Sent out invitations to six-hundred guests.
- Organized for the posters to be displayed on screens across campus.
- Hung up the posters and banners around campus with help from Mishal.
- Participated in creating promotional material for the exhibition in the degree show video.
- Wrote and gave the opening speech of the Exhibition. The presentation was shared with Mishal.
...
Ko, A. (2015). #BlackVegansRock: 100 Black Vegans to Check Out. [online] Striving with Systems. Available at: https://strivingwithsystems.com/2015/06/11/blackvegansrock- 100-black-vegans-to-check-out/ [Accessed 13 Jan. 2019].
...
Tate. (n.d.). Activist art – Art Term. [online] Available at: https://www.tate.org.uk/art/art-terms/a/activist-art [Accessed 5 Jan. 2019].
