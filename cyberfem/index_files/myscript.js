...
function checkAnswer(){
	...
	{current_string += " The internet is not always a place for politics. It is often an echocamber, with those who 'shout' the loudest representing the majority. It is not always safe and accesible to be politically active online.";

	}else if ((parseInt(pos)==2)&&(choice=="C"))
	{current_string += " The internet is a place of opinion. It is a platform for discussing politics and ideology, but it does not always represent individuals. This is because the internet is not always an accesible platform and may not be a safe place to be politically active.";
	...
	{current_string += " I believe in radical politics. Without extreme stances few significant changes will be made, and the real issues will not be targetted. There should be places for everyone to feel safe, both online and offline, i.e. internet platforms for women only.";
	...
	console.log("test: "+current_string);
